...
public interface BeneficiaryGroup {
    ...
    @PutMapping(value = "/idpay/group/organization/{organizationId}/initiative/{initiativeId}/upload")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "The requested ID was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class))),
            @ApiResponse(responseCode = "500", description = "Server ERROR", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class)))})
    @GetMapping(value = "/idpay/group/organization/{organizationId}/initiative/{initiativeId}/status")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "The requested ID was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class))),
            @ApiResponse(responseCode = "500", description = "Server ERROR", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDTO.class)))})
    @GetMapping(value = "/idpay/group/initiative/{initiativeId}/citizen/{citizenToken}")
